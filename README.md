...
./tools/build_release.ps1 -Version 0.1.9
```
...
```bash
./tools/build_macos_bundle.sh 0.1.9 osx-arm64 artifacts/packages
./tools/build_macos_bundle.sh 0.1.9 osx-x64 artifacts/packages
```
...
```bash
./tools/build_linux_package.sh 0.1.9 linux-x64 artifacts/packages
./tools/build_linux_package.sh 0.1.9 linux-arm64 artifacts/packages
```
