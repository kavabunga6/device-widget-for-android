...
val companionVersion = Properties()
rootProject.file("version.properties").inputStream().use(companionVersion::load)
...
android {
    ...
    defaultConfig {
        ...
        minSdk = 26
        targetSdk = 36
        versionCode = companionVersion.getProperty("VERSION_CODE").toInt()
        versionName = companionVersion.getProperty("VERSION_NAME")
    }
